  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch(
        `https://script.google.com/macros/s/AKfycbySrZYxI-NNnXfxY1jXOqHgT2HQi4zst2Fgte6FXTeymat_W_r0o1E3P83EfnVCjEk0/exec?action=delivery_email&email=${encodeURIComponent(email)}&store=GAC01`,
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          Green Air Cannabis is launching delivery across Mississauga.
        ...
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoCard}>
            <span className={styles.infoIcon}>🌉</span>
            <h3 className={styles.infoTitle}>Serving Mississauga</h3>
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            ...
            we are <strong>Open Daily: 10:00 AM - 02:00 AM</strong>. Call <strong>+1 (289) 514-9467</strong>.
          </p>
        </div>
      </div>
      <Footer />
