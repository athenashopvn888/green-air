...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>7060 Airport Rd, Mississauga</strong>. We are open daily <strong>10:00 AM - 02:00 AM</strong>. Call <strong>(437) 707-1207</strong>.</p></div>
