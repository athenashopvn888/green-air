...
export const metadata: Metadata = {
  title: "FAQ — Green Air Cannabis | Mississauga Dispensary Questions",
  description:
    "Frequently asked questions about Green Air Cannabis in Mississauga. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
    canonical: "https://greenaircannabis.com/faq",
  },
};
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Green Air Cannabis located?", a: "We are located at 7060 Airport Rd, Mississauga, ON L4T 2G8. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      ...
      { q: "What's the best way to get to Green Air Cannabis?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at greenaircannabis.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Green Air Cannabis is walk-in only. Just show up anytime — we are open daily from 10:00 AM to 02:00 AM." },
      { q: "Can I order online?", a: "Currently, Green Air Cannabis is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="Green Air Cannabis FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about Green Air Cannabis — Mississauga&apos;s premium dispensary at 7060 Airport Rd in Mississauga.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call us at <strong>(437) 707-1207</strong> or visit us at 7060 Airport Rd, Mississauga.
            </p>
          </div>
        </div>
        <Footer />
