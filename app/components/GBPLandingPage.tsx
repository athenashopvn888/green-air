    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.infoText}>
          ...
          {", "}
          <Link href="/cannabis-delivery-malton">Malton delivery</Link>
          {", "}
          <Link href="/native-cigarettes-malton">Native cigarettes</Link>
          {", and "}
          <Link href="/nicotine-vape-malton">nicotine vapes</Link>.
        </p>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.infoText}>
          These category links help adults 19+ browse general menu sections before visiting. Product selection can change, so use the live menu for current details rather than assuming listings from this guide.
        </p>
        <div className={styles.productGrid}>
