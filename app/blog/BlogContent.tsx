...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Green Air Cannabis is Mississauga's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=GAC01`)
      .then((r) => r.json())
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Green Air Cannabis <span className={styles.heroAccent}>Blog</span>
          </h1>
