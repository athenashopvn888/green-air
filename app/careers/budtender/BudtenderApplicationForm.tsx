...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Green Air" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="GAC01" />
      <input type="hidden" name="StoreName" value="Green Air Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Green Air Cannabis?</span>
