...
> = {
  EXOTIC: {
    ...
    color: "#f59e0b",
    icon: "\uD83D\uDD25",
    tagline: "Explore Green Air Cannabis's exotic flower tier",
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoTitle: "Cannabis Edibles Mississauga | Green Air Cannabis",
    seoIntro: "Browse edible options at Green Air Cannabis. Compare product names, package details, posted notes, and current menu information before choosing.",
    seoDescription: "Edibles shop best when you compare the exact listing instead of guessing from an old example. Use the current menu at Green Air Cannabis for names, package details, posted prices, and staff help when needed.",
    faqs: [
      { q: "What edibles are listed at Green Air Cannabis?", a: "Use the current menu to compare edible names, package details, prices, and item notes." },
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Vapes Mississauga | Green Air Cannabis",
    seoIntro: "Compare vape listings at Green Air Cannabis by product name, format, posted notes, and current menu details.",
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "Disposable Vapes Mississauga | Green Air Cannabis",
    seoIntro: "Use the disposable vape category at Green Air Cannabis for current product names, formats, and menu notes.",
  ...
  CONCENTRATES: {
    ...
    seoTitle: "Concentrates Mississauga | Green Air Cannabis",
    seoIntro: "Compare concentrates at Green Air Cannabis by product type, name, posted notes, and current menu details.",
  ...
  PREROLLS: {
    ...
    seoTitle: "Pre-Rolls Mississauga | Green Air Cannabis",
    seoIntro: "Shop pre-rolls at Green Air Cannabis by comparing the current product name, format, package details, and posted notes.",
  ...
  "ADD ONS": {
    ...
    seoTitle: "Cannabis Accessories Mississauga | Green Air Cannabis",
    seoIntro: "Browse accessories at Green Air Cannabis and compare the current menu notes before visiting.",
  ...
  "MAGIC & OTHERS": {
    ...
    seoTitle: "Specialty Items | Green Air Cannabis",
    seoIntro: "Browse specialty items only where they are listed on the current Green Air Cannabis menu.",
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Mississauga | Green Air Cannabis",
    seoIntro: "Native smokes at Green Air Cannabis in Mississauga. The cigarette menu may show $25 carton-style listings and brands such as Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, and Canadian Classics Silver.",
    seoDescription: "Use the cigarette category to compare current Native smoke listings at Green Air Cannabis. Specific brands, carton options, and prices can change, so check the current menu or ask staff before visiting.",
    faqs: [
      { q: "Does Green Air Cannabis list Native cigarettes?", a: "Check the cigarette category for current Native smoke listings and brand names." },
