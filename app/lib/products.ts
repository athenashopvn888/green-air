...
export async function fetchLiveProducts(): Promise<{
  ...
  try {
    const res = await fetch(`${APPS_SCRIPT_URL}?store=GAC01`, {
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Green Air Cannabis?", a: "Yes! Visit us at 7060 Airport Rd, Mississauga. We're open daily from 10:00 AM to 02:00 AM with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    ...
    seoIntro: "Shop THC and nicotine vape pens at Green Air Cannabis, Mississauga. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "Green Air Cannabis carries a curated selection of vape pens and cartridges in Mississauga. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 7060 Airport Rd for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Green Air Cannabis, Mississauga. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Green Air Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 7060 Airport Rd, Mississauga.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at Green Air Cannabis, Mississauga. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "Green Air Cannabis offers a premium selection of cannabis concentrates in Mississauga. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 7060 Airport Rd.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at Green Air Cannabis, Mississauga. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "Green Air Cannabis carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 7060 Airport Rd, Mississauga.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoDescription: "Green Air Cannabis is your go-to source for affordable native cigarettes in Mississauga. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 7060 Airport Rd in the heart of 7060 Airport Rd & Nearby Expressway, we're Open Daily: 10:00 AM - 02:00 AM.",
    faqs: [
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Green Air Cannabis, Mississauga.",
    seoDescription: "Green Air Cannabis carries a curated selection of magic mushrooms and specialty products in Mississauga. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 7060 Airport Rd for our full selection.",
    faqs: [
