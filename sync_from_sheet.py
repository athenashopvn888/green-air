"""
Green Air Cannabis - Auto Sync from Google Sheets
==========================================
...
a filtered menu for Green Air Cannabis (ALC01).
...
def main():
    print("=" * 60)
    print(f"  Green Air Cannabis - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://greenaircannabis.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
